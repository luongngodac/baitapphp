...
<body>
    ...
    <form align='center' action="" method="post">
        <table border="0">
            <tr bgcolor="coral">
            <th colspan="2" text-align="center"><h3><font color="blue">THÊM MỚI SỮA</font></h3></th>
            </tr>
            ...
            <tr><td>Thành phần dinh dưỡng: </td>
            <td><input type="text" name="toan" value="<?php  echo $toan;?> "/></td>
            </tr>
            <tr><td>Lợi ích: </td>
            <td><input type="text" name="toan" value="<?php  echo $toan;?> "/></td>
            ...
            <tr>
            <td colspan="2" align="center"><input type="submit" value="Thêm mới" name="tinh" /></td>
            </tr>
        </table>
