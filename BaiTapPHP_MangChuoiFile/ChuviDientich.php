...
<body>
	...
	class HinhTamGiac extends Hinh
	{
		...
		public function tinh_DT()
		{
			...
			return round((pow($this->dodai, 2) * sqrt(3)) / 4, PHP_ROUND_HALF_UP);
		}
	}
	...
	if (isset($_POST['tinh'])) {
		...
		if (isset($_POST['hinh']) && ($_POST['hinh']) == "hcn") {
			...
			$str = "Diện tích hình chữ nhật " . $hcn->getTen() . " là : " . $hcn->tinh_DT() . " \n" .
				...
				"\n Chiều rộng hình chữ nhật là độ dài; Chiều dài gấp đôi chiều rộng.";
		}
	}
			...
			<table border='0'>
				...
				<tr>
					...
					<td><input type="radio" name="hinh" value="hv" <?php if (isset($_POST['hinh']) && ($_POST['hinh']) == "hv") echo 'checked="checked"' ?> />Hình vuông
						...
						<input type="radio" name="hinh" value="htg" <?php if (isset($_POST['hinh']) && ($_POST['hinh']) == "htg") echo 'checked="checked"' ?> />Hình tam giác</td>
				</tr>
