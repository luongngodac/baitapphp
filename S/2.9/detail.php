    ...
    $result = mysqli_query($connection, "SELECT TP_Dinh_Duong, Loi_ich, Hinh, Ten_sua, Trong_luong, Don_gia, Ten_loai, Ten_hang_sua FROM sua WHERE Ten_sua LIKE '%$searchText%' LIMIT $offset, $rowsPerPage");
